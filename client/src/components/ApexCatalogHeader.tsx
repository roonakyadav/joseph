...
export function ApexCatalogHeader({ active = "accounts" }: { active?: "home" | "accounts" | "proofs" }) {
  ...
  return (
    <>
      <header className="catalog-header">
        ...
        <div className="catalog-header-meta"><span>Build / 04</span><button className="catalog-index-trigger focus-ring" type="button" onClick={() => setIndexOpen(true)} aria-expanded={indexOpen} aria-controls="catalog-index"><i /> Index <b>{active === "proofs" ? "04" : active === "accounts" ? "02" : "01"}</b></button></div>
      </header>

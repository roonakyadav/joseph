...
export default function Sell() {
  ...
  return <div className="sell-page"><div className="sell-grid" aria-hidden="true" /><ApexCatalogHeader active="sell" /><main className="sell-main">
    <section className="sell-intro" aria-labelledby="sell-title"><div className="sell-rail"><p className="eyebrow"><i /> Elite Traders / Seller intake</p><span>Review protocol / 03</span></div><div className="sell-intro-copy"><h1 id="sell-title">Prepare an<br /><em>account record.</em></h1><p>Compile squad detail and account evidence for review. No record is published until Elite Traders makes an explicit decision.</p><button type="button" className="sell-primary focus-ring" onClick={startSubmission}>Fill details <ArrowDown size={16} /></button></div><aside className="sell-intake-stamp"><span className="sell-a-seal" aria-hidden="true"><img src="/manus-storage/apex-mark_890b511d.png" alt="" /></span><p>Submission review</p><strong>Not a self-publish route</strong><small>Prepared account records are reviewed before any public decision.</small></aside></section>

    ...
    <main className="min-h-screen bg-[#0e120f] px-5 py-8 text-[#f0f1ea] sm:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-5xl flex-col border border-[#f0f1ea]/15 bg-[#111611] p-6 sm:p-10">
        <header className="flex items-center justify-between border-b border-[#f0f1ea]/15 pb-5 font-mono text-[10px] uppercase tracking-[0.16em] text-[#aeb4aa]">
          <Link href="/" className="focus-ring flex items-center gap-2 text-[#f0f1ea]" aria-label="Elite Traders home"><span className="font-bold text-[#77d44d]">E</span> Elite Traders</Link>
        ...
        <section className="my-auto max-w-2xl py-16" aria-labelledby="missing-record-title">
          ...
          <p className="mt-6 max-w-xl text-base leading-7 text-[#c5c9c0]">The requested address does not correspond to a current Elite Traders public record. It may have moved, been archived, or never been published.</p>
        ...
        <footer className="border-t border-[#f0f1ea]/15 pt-5 font-mono text-[10px] uppercase tracking-[0.14em] text-[#aeb4aa]">Elite Traders / Public archive · Use the published index to continue.</footer>
      </div>
    </main>
  );
}

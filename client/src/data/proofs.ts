...
export const developmentProofs: ProofRecord[] = [
  {
    ...
    imageAlt: "Development-only example of a redacted Elite Traders proof record layout; it contains no personal or transaction data.",
    kind: "account-record",
  ...
  },
  {
    ...
    imageAlt: "Development-only Elite Traders handover archive illustration with redacted information; it contains no authentic conversation or payment data.",
    kind: "handover",
  ...
  },
  {
    ...
    imageAlt: "Development-only Elite Traders confirmation archive illustration with no personal or payment information.",
    kind: "confirmation",
